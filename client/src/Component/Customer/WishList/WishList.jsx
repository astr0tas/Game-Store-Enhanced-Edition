...
const CustomerWishList = () =>
{
      ...
      useEffect(() =>
      {
            ...
            axios.post(`http://${ domain }/getWishlist`, formData, { withCredentials: true })
                  .then(res =>
                  {
                        let numOfElem;
                        ...
                        {
                              if (numOfElem === 1)
                                    temp.push(<Group render={ render } setRender={ setRender } numOfElem={ numOfElem } i={ i * numOfElem } key={ i } data={ [res.data[i * numOfElem]] } />);
                              else if (numOfElem === 2)
                                    temp.push(<Group render={ render } setRender={ setRender } numOfElem={ numOfElem } i={ i * numOfElem } key={ i } data={ [res.data[i * numOfElem], res.data[i * numOfElem + 1]] } />);
                              else if (numOfElem === 3)
                                    temp.push(<Group render={ render } setRender={ setRender } numOfElem={ numOfElem } i={ i * numOfElem } key={ i } data={ [res.data[i * numOfElem], res.data[i * numOfElem + 1], res.data[i * numOfElem + 2]] } />);
                              else
